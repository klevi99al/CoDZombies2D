...
public class PerkJuggernog : MonoBehaviour
{
    [Header("Perk References")]
    public int cost;
    public int juggernogHealth = 200;
    public float drinkAnimationTime = 1;
    public string purchaseStringFirstPart = "Press and hold <color=yellow>F</color> to buy Juggernog[Cost: <color=yellow>";
    ...
    private void SetPerkEffect(GameObject player)
    {
        PlayerHealth playerHealth = player.GetComponent<PlayerHealth>();
        playerHealth.playerMaxHealth = juggernogHealth;
        playerHealth.playerHealth = juggernogHealth;
        playerHealth.dividor = juggernogHealth;
        playerHealth.healTimer /= 2;
        playerHealth.healthSlider.value = 1;
        HUD.Instance.playerHealthbarNumber.text = "100%";
    }
