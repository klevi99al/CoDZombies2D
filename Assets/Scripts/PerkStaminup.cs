...
public class PerkStaminup : MonoBehaviour
{
    [Header("Perk References")]
    public int cost = 2000;
    public float drinkAnimationTime = 1;
    public float speedIncrease = 0.5f;
    public string purchaseStringFirstPart = "Press and hold <color=yellow>F</color> to buy Staminup[Cost: <color=yellow>";
    ...
    private void SetPerkEffect(GameObject player)
    {
        ...
        movement.movementSpeed += speedIncrease;
    }
    ...
    {
        if (other.gameObject.CompareTag("Player") && perkIsActive == true)
        {
            playersTouchingPerk++;
